...
mod test {
    ...
    fn child_hash() {
        ...
        assert_eq!(
            ...
            &[
                100, 181, 174, 190, 126, 127, 236, 85, 67, 214, 206, 186, 5, 68, 54, 37, 112, 63,
                40, 198, 136, 199, 172, 163, 222, 177, 113, 157, 153, 76, 92, 167
            ]
        );
    ...
    fn hash() {
        ...
        assert_eq!(
            tree.hash(),
            [
                20, 148, 172, 120, 209, 29, 44, 201, 154, 20, 73, 142, 220, 58, 202, 191, 113, 49,
                8, 111, 151, 66, 137, 183, 57, 129, 60, 236, 111, 205, 110, 73
            ]
        );
    }
